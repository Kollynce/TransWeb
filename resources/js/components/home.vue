            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 wow fadeIn" data-wow-delay=".3s">
                        <h2 class="font-weight-sbold text-capitalize text-center text-lg-left">Your journey to digital transformation starts <span class="text-capitalize text-primary">here</span></h2>
                        <h6 class="font-weight-light text-center text-lg-left">We provide advanced software engineering products. Our services encompass software development, website design, website development, graphic design, app development, Search Engine Optimization (SEO), and a wide range of customized software services.<br class="d-none d-lg-block"></h6>
            ...
            <div class="container">
                <div class="row row-40">
                    ...
                    <div class="col-lg-6 text-center text-lg-left wow fadeInRight block-lg-2" data-wow-delay=".2s">
                        ...
                        <div class="row row-40 offset-top-0 offset-top-30-2">
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                ...
                                <h6 class="font-weight-light text-gray-650">TW Technologies is fully result-oriented to offer you the best outcome for your business</h6>
                            </div>
                        </div>
                    </div>
                </div>
