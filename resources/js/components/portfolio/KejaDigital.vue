<template>
	<div class="container">
		<div class="row row-50 mt-5 ml-5">
			<h3 class="font-weight-sbold text-left wow fadeIn" data-wow-delay=".3s">Keja Digital</h3>
		</div>
		<div class="row">
			<div class="col-sm-6 col-lg-6 text-center text-sm-left wow fadeInRight">
				<img src="assets/images/keja.jpg" alt="img" class="w-100">
				<div class="description p-3">
					<h5>Client: Tw Technologies</h5>
					<h5>Category: Web based system.</h5>
					<h5>Description: Property Management system.</h5>
				</div>
            </div>
            <div class="col-sm-6 col-lg-6 text-center text-sm-left wow fadeInRight">
            	<h5>Keja Digital</h5>
				...
				of their occupied and vacant units.</p>
