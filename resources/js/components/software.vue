            ...
            <div class="container">
                <div class="row row-50">
                    ...
                    <div class="col-lg-4"><a class="box-lola-wrapper" href="#">
                        ...
                        <div class="box-lola">
                            <div class="small-text font-weight-sbold ls-1 lh-4"> Web Development</div>
                        </div></a><a class="box-lola-wrapper" href="#">
                        <div class="box-lola">
                            <div class="small-text font-weight-sbold ls-1 lh-4"> Wed Design</div>
                        </div></a><a class="box-lola-wrapper" href="#">
                        <div class="box-lola">
                        ...
                        <a class="box-lola-wrapper" href="#">
                            <div class="box-lola">
                                <div class="small-text font-weight-sbold ls-1 lh-4"> Virtual Raelity</div>
                            </div>
                        </a>
                        <a class="box-lola-wrapper" href="#">
                            <div class="box-lola">
                        ...
                        <a class="box-lola-wrapper" href="#">
                            <div class="box-lola">
                                <div class="small-text font-weight-sbold ls-1 lh-4"> Programming Solutions</div>
                            </div>
                        </a>
                        <div class="box-tina">
